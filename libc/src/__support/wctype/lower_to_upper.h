...
LIBC_INLINE_VAR constexpr cpp::array<cpp::array<wint_t, 2>, 1151>
    LOWER_TO_UPPER_DATA = {
...
LIBC_INLINE_VAR constexpr PerfectHashMap<1151, decltype(LOWER_TO_UPPER_HASHER)>
    LOWER_TO_UPPER_MAP{LOWER_TO_UPPER_DATA, LOWER_TO_UPPER_HASHER};

#if WINT_MAX > 65535

LIBC_INLINE_VAR constexpr cpp::array<cpp::array<wint_t, 2>, 307>
    LOWER_TO_UPPER_DATA_32 = {
...
LIBC_INLINE_VAR constexpr auto LOWER_TO_UPPER_HASHER_32 =
    ptrhash::init_hasher<307>(
        0x1A275D28E2768536,
...
LIBC_INLINE_VAR constexpr PerfectHashMap<307,
                                         decltype(LOWER_TO_UPPER_HASHER_32)>
    LOWER_TO_UPPER_MAP_32{LOWER_TO_UPPER_DATA_32, LOWER_TO_UPPER_HASHER_32};
