...
public:
  ...
  static void bindDerived(ClassTy &c) {
    c.def_static(
        ...
        // clang-format off
        nb::sig("def get(dialect_namespace: str, buffer: typing_extensions.Buffer, type: " MAKE_MLIR_PYTHON_QUALNAME("ir.Type") ", context: typing_extension.Optional[" MAKE_MLIR_PYTHON_QUALNAME("ir.Context") "] = None) -> " MAKE_MLIR_PYTHON_QUALNAME("ir.OpaqueAttr")),
        // clang-format on
  ...
  static void bindDerived(ClassTy &c) {
    ...
    c.def("__len__", &PyDenseElementsAttribute::dunderLen)
        .def_static(
            ...
            // clang-format off
                    nb::sig("def get(array: typing_extensions.Buffer, signless: bool = True, type: typing_extension.Optional[" MAKE_MLIR_PYTHON_QUALNAME("ir.Type") "] = None, shape: typing_extension.Optional[Sequence[int]] = None, context: typing_extension.Optional[" MAKE_MLIR_PYTHON_QUALNAME("ir.Context") "] = None) -> " MAKE_MLIR_PYTHON_QUALNAME("ir.DenseElementsAttr")),
            // clang-format on
...
public:
  ...
  static void bindDerived(ClassTy &c) {
    c.def_static(
        ...
        nb::arg("context") = nb::none(),
        // clang-format off
        nb::sig("def get_from_buffer(array: typing_extensions.Buffer, name: str, type: " MAKE_MLIR_PYTHON_QUALNAME("ir.Type") ", alignment: typing_extension.Optional[int] = None, is_mutable: bool = False, context: typing_extension.Optional[" MAKE_MLIR_PYTHON_QUALNAME("ir.Context") "] = None) -> " MAKE_MLIR_PYTHON_QUALNAME("ir.DenseResourceElementsAttr")),
        // clang-format on
