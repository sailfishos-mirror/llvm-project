...
// CHECK:  %[[VAL_11_1:.*]] = icmp ne i64 0, %[[VAL_11]]
// CHECK:  %[[VAL_11_2:.*]] = select i1 %[[VAL_11_1]], i64 %[[VAL_11]], i64 ptrtoint (ptr getelementptr (ptr, ptr null, i32 1) to i64)
...
// CHECK:  store i64 %[[VAL_11_2]], ptr %[[SIZES]], align 8
