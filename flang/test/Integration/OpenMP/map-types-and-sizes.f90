...
!CHECK: @.offload_sizes{{.*}} = private unnamed_addr constant [10 x i64] [i64 0, i64 0, i64 0, i64 0, i64 48, i64 0, i64 4, i64 0, i64 0, i64 0]
!CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [10 x i64] [i64 32, i64 281474976710661, i64 281474976710661, i64 0, i64 281474976710661, i64 3, i64 281474976710659, i64 16384, i64 16384, i64 288]
...
!CHECK: %[[SIZE_CALC_7:.*]] = ptrtoaddr ptr %[[DTYPE_BASE_ADDR_ACCESS_3]] to i64
!CHECK: %[[SIZE_CALC_8:.*]] = ptrtoaddr ptr %[[DTYPE_DESC_ALLOCA_3]] to i64
!CHECK: %[[SIZE_CALC_9:.*]] = sub i64 %[[SIZE_CALC_7]], %[[SIZE_CALC_8]]
!CHECK: %[[CALC_SIZE_2:.*]] = icmp ne i64 0, %[[SIZE_CALC_9]]
!CHECK: %[[CALC_SIZE_3:.*]] = select i1 %[[CALC_SIZE_2]], i64 %[[SIZE_CALC_9]], i64 ptrtoint (ptr getelementptr (ptr, ptr null, i32 1) to i64)
!CHECK: %[[OFFLOAD_PTR:.*]] = getelementptr ptr, ptr %[[DTYPE_BASE_ADDR_ACCESS_3]], i32 1
!CHECK: %[[SIZE_CALC_10:.*]] = ptrtoaddr ptr %[[SIZE_CALC_6]] to i64
!CHECK: %[[SIZE_CALC_11:.*]] = ptrtoaddr ptr %[[OFFLOAD_PTR]] to i64
...
!CHECK: store ptr %[[DTYPE_DESC_ALLOCA_3]], ptr %[[OFFLOAD_PTR_ARR]], align 8
!CHECK: %[[OFFLOAD_SIZE_ARR:.*]] = getelementptr inbounds [10 x i64], ptr %.offload_sizes, i32 0, i32 1
!CHECK: store i64 %[[CALC_SIZE_3]], ptr %[[OFFLOAD_SIZE_ARR]], align 8
...
!CHECK:  %[[SIZE_CALC_4:.*]] = sub i64 %[[SIZE_CALC_2]], %[[SIZE_CALC_3]]
!CHECK:  %[[SIZE_CALC_6:.*]] = getelementptr { ptr, i64, i32, i8, i8, i8, i8, ptr, [1 x i64] }, ptr %[[DTYPE_DESC_ALLOCA_3]], i32 1
!CHECK:  %[[SIZE_CALC_7:.*]] = ptrtoaddr ptr %36 to i64
!CHECK:  %[[SIZE_CALC_8:.*]] = ptrtoaddr ptr %[[DTYPE_DESC_ALLOCA_3]] to i64
!CHECK:  %[[SIZE_CALC_9:.*]] = sub i64 %[[SIZE_CALC_7]], %[[SIZE_CALC_8]]
!CHECK:  %[[CALC_SIZE1:.*]] = icmp ne i64 0, %[[SIZE_CALC_9]]
!CHECK:  %[[CALC_SIZE2:.*]] = select i1 %[[CALC_SIZE1]], i64 %[[SIZE_CALC_9]], i64 ptrtoint (ptr getelementptr (ptr, ptr null, i32 1) to i64)
...
!CHECK: store ptr %[[DTYPE_DESC_ALLOCA_3]], ptr %[[OFFLOAD_PTR_ARR]], align 8
!CHECK: %[[OFFLOAD_SIZE_ARR:.*]] = getelementptr inbounds [10 x i64], ptr %.offload_sizes, i32 0, i32 1
!CHECK: store i64 %[[CALC_SIZE2]], ptr %[[OFFLOAD_SIZE_ARR]], align 8
!CHECK: %[[BASE_PTR_ARR:.*]] = getelementptr inbounds [10 x ptr], ptr %.offload_baseptrs, i32 0, i32 2
!CHECK: store ptr %[[DTYPE_DESC_ALLOCA_3]], ptr %[[BASE_PTR_ARR]], align 8
!CHECK: %[[OFFLOAD_PTR_ARR:.*]] = getelementptr inbounds [10 x ptr], ptr %.offload_ptrs, i32 0, i32 2
!CHECK: store ptr %[[OFFLOAD_PTR]], ptr %[[OFFLOAD_PTR_ARR]], align 8
