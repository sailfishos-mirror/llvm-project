...
!CHECK: %[[CALC_SIZE_2:.*]] = icmp ne i64 0, %[[CALC_SIZE_1]]
!CHECK: %[[CALC_SIZE_3:.*]] = select i1 %[[CALC_SIZE_2]], i64 %[[CALC_SIZE_1]], i64 ptrtoint (ptr getelementptr (ptr, ptr null, i32 1) to i64)
...
!CHECK:  %[[CALC_SIZE1:.*]] = icmp ne i64 0, %[[CALC_SIZE]]
!CHECK:  %[[CALC_SIZE2:.*]] = select i1 %[[CALC_SIZE1]], i64 %[[CALC_SIZE]], i64 ptrtoint (ptr getelementptr (ptr, ptr null, i32 1) to i64)
