...
// RUN: -mattr=+rcpc3,+lse128,+sysinstr128,+d128,+the,+rasv2,+ite,+cssc,+specres2,+gcs,+cmpbr \
...
// nolse128 implied nod128 and nosysinstr128, so reinstate them
.arch_extension sysinstr128
.arch_extension d128
...
// CHECK-NOT: [[@LINE-2]]:1: error: instruction requires: sysinstr128
// CHECK-NOT: [[@LINE-2]]:1: error: instruction requires: d128
.arch_extension nosysinstr128
.arch_extension nod128
sysp #0, c2, c0, #0, x0, x1
rcwcasp   x0, x1, x6, x7, [x4]
// CHECK: [[@LINE-2]]:1: error: instruction requires: sysinstr128
