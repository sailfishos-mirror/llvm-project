...
; GFX9-NEXT:    [[TMP2:%.*]] = extractelement <6 x i32> [[TMP1]], i64 0
; GFX9-NEXT:    [[TMP3:%.*]] = extractelement <6 x i32> [[TMP1]], i64 1
...
; GFX9-NEXT:    [[TMP2:%.*]] = extractelement <6 x i64> [[TMP1]], i64 0
; GFX9-NEXT:    [[TMP3:%.*]] = extractelement <6 x i64> [[TMP1]], i64 1
