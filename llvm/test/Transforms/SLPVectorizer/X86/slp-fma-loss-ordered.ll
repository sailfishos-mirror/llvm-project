...
; FMA-NEXT:    [[TMP3:%.*]] = fmul <4 x double> <double 7.000000e+00, double -4.300000e+01, double 2.200000e-02, double 9.500000e+00>, [[TMP2]]
; FMA-NEXT:    [[ADD3:%.*]] = call double @llvm.vector.reduce.fadd.v4f64(double [[CVT0]], <4 x double> [[TMP3]])
; FMA-NEXT:    ret double [[ADD3]]
;
  %cvt0 = uitofp i16 3 to double
