...
; CHECK-NEXT:    [[SHL34:%.*]] = xor i32 0, [[TRUNC]]
...
; CHECK-NEXT:    [[TMP16:%.*]] = insertelement <4 x i32> [[TMP15]], i32 [[XOR31]], i32 1
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP16]], i32 [[SHL35]], i32 2
...
; CHECK-NEXT:    [[OP_RDX:%.*]] = call i64 @llvm.vector.reduce.add.v8i64(<8 x i64> [[TMP14]])
; CHECK-NEXT:    [[OP_RDX4:%.*]] = add i64 [[OP_RDX]], [[OP_RDX1]]
; CHECK-NEXT:    [[OP_RDX5:%.*]] = add i64 [[SEXT35]], [[SEXT22]]
