...
; CHECK-NEXT:    [[TMP3:%.*]] = trunc <4 x i64> [[TMP0]] to <4 x i32>
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> poison, <6 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 1>
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <6 x i32> [[TMP4]], <6 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 poison>, <6 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 10, i32 5>
; CHECK-NEXT:    [[TMP19:%.*]] = trunc <4 x i64> [[TMP0]] to <4 x i32>
; CHECK-NEXT:    [[TMP20:%.*]] = shufflevector <4 x i32> [[TMP19]], <4 x i32> poison, <6 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <6 x i32> [[TMP5]], <6 x i32> [[TMP20]], <6 x i32> <i32 6, i32 7, i32 8, i32 9, i32 4, i32 5>
...
; CHECK-NEXT:    [[TMP10:%.*]] = trunc <4 x i64> [[TMP0]] to <4 x i32>
; CHECK-NEXT:    [[TMP11:%.*]] = trunc <4 x i64> [[TMP0]] to <4 x i32>
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <4 x i32> [[TMP11]], <4 x i32> poison, <8 x i32> <i32 1, i32 2, i32 2, i32 3, i32 3, i32 3, i32 2, i32 1>
