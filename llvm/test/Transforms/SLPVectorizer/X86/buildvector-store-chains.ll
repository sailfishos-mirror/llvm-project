...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <3 x float> poison, float [[A0]], i64 0
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <3 x float> [[TMP0]], float [[A1]], i64 1
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <3 x float> [[TMP1]], float [[A2]], i64 2
