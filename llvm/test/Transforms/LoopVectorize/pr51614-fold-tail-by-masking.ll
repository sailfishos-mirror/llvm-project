...
; CHECK-NEXT:    [[TMP26:%.*]] = add <2 x i16> [[VEC_PHI]], [[TMP24]]
; CHECK-NEXT:    [[TMP25]] = select <2 x i1> [[TMP1]], <2 x i16> [[TMP26]], <2 x i16> [[VEC_PHI]]
...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP28:%.*]] = call i16 @llvm.vector.reduce.add.v2i16(<2 x i16> [[TMP25]])
