...
; CHECK-NEXT:    [[TMP7:%.*]] = select <vscale x 4 x i1> [[TMP12]], <vscale x 4 x i1> [[BROADCAST_SPLAT4]], <vscale x 4 x i1> zeroinitializer
; CHECK-NEXT:    [[TMP2:%.*]] = or <vscale x 4 x i1> [[TMP5]], [[TMP7]]
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[TMP8:%.*]] = call <vscale x 4 x float> @llvm.vp.merge.nxv4f32(<vscale x 4 x i1> splat (i1 true), <vscale x 4 x float> splat (float 1.000000e+00), <vscale x 4 x float> zeroinitializer, i32 57)
...
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <vscale x 4 x i1> [[TMP6]], <vscale x 4 x float> splat (float 2.000000e+00), <vscale x 4 x float> [[TMP8]]
; CHECK-NEXT:    [[PREDPHI5:%.*]] = select <vscale x 4 x i1> [[TMP6]], <vscale x 4 x float> splat (float 2.000000e+00), <vscale x 4 x float> [[PREDPHI]]
