...
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i32 [ 0, %[[VEC_EPILOG_SCALAR_PH1]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; CHECK-NEXT:    [[PTR_IV:%.*]] = phi ptr [ [[A]], %[[VEC_EPILOG_SCALAR_PH1]] ], [ [[PTR_IV_NEXT:%.*]], %[[LOOP]] ]
; CHECK-NEXT:    [[PTR_IV_OFFSET:%.*]] = phi ptr [ [[A_OFFSET]], %[[VEC_EPILOG_SCALAR_PH1]] ], [ [[PTR_IV_OFFSET_NEXT:%.*]], %[[LOOP]] ]
