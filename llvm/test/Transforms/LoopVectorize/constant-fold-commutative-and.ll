...
; CHECK-NEXT:    [[TMP13:%.*]] = icmp ult <2 x i64> [[BROADCAST_SPLAT2]], splat (i64 7)
; CHECK-NEXT:    [[TMP7:%.*]] = xor <2 x i1> [[TMP1]], splat (i1 true)
; CHECK-NEXT:    [[PREDPHI3:%.*]] = select <2 x i1> [[TMP12]], <2 x i1> [[TMP13]], <2 x i1> [[TMP7]]
