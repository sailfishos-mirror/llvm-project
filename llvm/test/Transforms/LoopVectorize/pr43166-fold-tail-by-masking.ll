...
; CHECK:       middle.block:
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <4 x i1> <i1 false, i1 false, i1 false, i1 true>, <4 x i64> [[BROADCAST_SPLAT]], <4 x i64> splat (i64 77)
...
; CHECK-NEXT:    [[FIRST_INACTIVE_LANE:%.*]] = call i64 @llvm.experimental.cttz.elts.i64.v4i1(<4 x i1> <i1 false, i1 false, i1 false, i1 true>, i1 false)
; CHECK-NEXT:    [[LAST_ACTIVE_LANE:%.*]] = sub i64 [[FIRST_INACTIVE_LANE]], 1
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <4 x i64> <i64 77, i64 77, i64 77, i64 55>, i64 [[LAST_ACTIVE_LANE]]
; CHECK-NEXT:    br label [[COND_END:%.*]]
; CHECK:       for.cond.cleanup:
...
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <4 x i32> <i32 0, i32 1, i32 2, i32 55>, i64 [[TMP3]]
; CHECK-NEXT:    br label [[COND_END:%.*]]
; CHECK:       for.cond.cleanup:
