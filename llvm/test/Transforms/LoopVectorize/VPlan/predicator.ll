...
; CHECK-NEXT:      BLEND ir<%phi3> = ir<%add2>/vp<[[VP14]]> ir<%add1>/vp<[[VP10]]>
...
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/vp<[[VP8]]> ir<%add3>/vp<[[VP15]]> ir<%add2>/vp<[[VP17]]> ir<%add1>/vp<[[VP13]]>
...
; CHECK-NEXT:      BLEND ir<%phi> = ir<1>/vp<[[VP15]]> ir<0>/vp<[[VP11]]>
...
; CHECK-NEXT:      BLEND ir<%phi3> = ir<%add2>/vp<[[VP7]]> ir<%add1>/vp<[[VP4]]>
...
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add3>/vp<[[VP10]]> ir<%add2>/vp<[[VP6]]>
