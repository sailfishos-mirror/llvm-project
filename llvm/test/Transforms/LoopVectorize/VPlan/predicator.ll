...
; CHECK-EMPTY:
; CHECK-NEXT:    bb4:
; CHECK-NEXT:      EMIT vp<[[VP7:%[0-9]+]]> = not ir<%u0>
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add3>/ir<%u0> ir<%iv>/vp<[[VP7]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/vp<[[VP7]]> ir<%add3>/vp<[[VP6]]>
; CHECK-NEXT:      EMIT ir<%add5> = add ir<%phi5>, ir<5>, ir<%u0>
; CHECK-NEXT:    Successor(s): bb6
; CHECK-EMPTY:
; CHECK-NEXT:    bb6:
; CHECK-NEXT:      BLEND ir<%phi6> = ir<%add5>/ir<%u0> ir<%add1>/vp<[[VP4]]>
...
; CHECK-NEXT:      BLEND ir<%phi3> = ir<%add2>/vp<[[VP5]]> ir<%add1>/vp<[[VP7]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/ir<%v0> ir<%add3>/vp<[[VP4]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb4:
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add3>/vp<[[VP7]]> ir<%add2>/vp<[[VP6]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb6:
; CHECK-NEXT:      BLEND ir<%phi6> = ir<%add5>/ir<%v0> ir<%add4>/vp<[[VP4]]>
; CHECK-NEXT:      EMIT store ir<%phi6>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb6:
; CHECK-NEXT:      BLEND ir<%phi6> = ir<%add5>/ir<%v0> ir<%add1>/vp<[[VP4]]>
; CHECK-NEXT:      EMIT store ir<%phi6>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/vp<[[VP4]]> ir<%iv>/ir<%v0>
; CHECK-NEXT:      EMIT store ir<%phi5>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-NEXT:      EMIT vp<[[VP5:%[0-9]+]]> = not ir<%v2>
; CHECK-NEXT:      EMIT vp<[[VP6:%[0-9]+]]> = logical-and ir<%u0>, vp<[[VP5]]>
; CHECK-NEXT:      EMIT vp<[[VP7:%[0-9]+]]> = or vp<[[VP6]]>, vp<[[VP4]]>
; CHECK-NEXT:      BLEND ir<%phi3> = ir<%add2>/vp<[[VP6]]> ir<%add1>/vp<[[VP4]]>
; CHECK-NEXT:      EMIT ir<%add3> = add ir<%phi3>, ir<3>, vp<[[VP7]]>
; CHECK-NEXT:    Successor(s): bb4
; CHECK-EMPTY:
; CHECK-NEXT:    bb4:
; CHECK-NEXT:      EMIT vp<[[VP8:%[0-9]+]]> = logical-and ir<%u0>, ir<%v2>
; CHECK-NEXT:      EMIT ir<%add4> = add ir<%iv>, ir<4>, vp<[[VP8]]>
; CHECK-NEXT:    Successor(s): bb5
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/vp<[[VP8]]> ir<%add3>/vp<[[VP7]]>
; CHECK-NEXT:      EMIT store ir<%phi5>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add2>/vp<[[VP7]]> ir<%add1>/vp<[[VP4]]>
; CHECK-NEXT:      EMIT ir<%add4> = add ir<%phi4>, ir<4>, vp<[[VP8]]>
; CHECK-NEXT:    Successor(s): bb5
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/vp<[[VP8]]> ir<%add3>/vp<[[VP6]]>
; CHECK-NEXT:      EMIT store ir<%phi5>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add3>/ir<%u0> ir<%add1>/vp<[[VP7]]>
; CHECK-NEXT:      EMIT ir<%add4> = add ir<%phi4>, ir<4>, vp<[[VP8]]>
; CHECK-NEXT:    Successor(s): bb5
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      BLEND ir<%phi5> = ir<%add4>/vp<[[VP8]]> ir<%add2>/vp<[[VP6]]>
; CHECK-NEXT:      EMIT store ir<%phi5>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-NEXT:      EMIT vp<[[VP7:%[0-9]+]]> = logical-and vp<[[VP4]]>, vp<[[VP6]]>
; CHECK-NEXT:      EMIT vp<[[VP8:%[0-9]+]]> = or ir<%u0>, vp<[[VP7]]>
; CHECK-NEXT:      BLEND ir<%phi2> = ir<%add3>/ir<%u0> ir<%add1>/vp<[[VP7]]>
...
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add3>/vp<[[VP5]]> ir<%add2>/vp<[[VP7]]> ir<%add1>/vp<[[VP4]]>
; CHECK-NEXT:      EMIT store ir<%phi4>, ir<%a>
; CHECK-NEXT:      EMIT ir<%iv.next> = add nuw nsw ir<%iv>, ir<1>
; CHECK-NEXT:      EMIT ir<%ec> = icmp eq ir<%iv.next>, ir<128>
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP3]]>, vp<[[VP1:%[0-9]+]]>
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb4:
; CHECK-NEXT:      EMIT vp<[[VP8:%[0-9]+]]> = logical-and ir<%u0>, ir<%u2>
; CHECK-NEXT:      EMIT ir<%add4> = add ir<%iv>, ir<4>, vp<[[VP8]]>
; CHECK-NEXT:    Successor(s): bb5
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
...
; CHECK-EMPTY:
; CHECK-NEXT:    bb4:
; CHECK-NEXT:      EMIT vp<[[VP8:%[0-9]+]]> = not ir<%u3>
; CHECK-NEXT:      EMIT vp<[[VP9:%[0-9]+]]> = logical-and vp<[[VP7]]>, vp<[[VP8]]>
; CHECK-NEXT:      EMIT vp<[[VP10:%[0-9]+]]> = or vp<[[VP9]]>, vp<[[VP6]]>
; CHECK-NEXT:      BLEND ir<%phi4> = ir<%add3>/vp<[[VP9]]> ir<%add2>/vp<[[VP6]]>
; CHECK-NEXT:      EMIT ir<%add4> = add ir<%phi4>, ir<4>, vp<[[VP10]]>
; CHECK-NEXT:    Successor(s): bb5
; CHECK-EMPTY:
; CHECK-NEXT:    bb5:
; CHECK-NEXT:      EMIT vp<[[VP11:%[0-9]+]]> = logical-and vp<[[VP7]]>, ir<%u3>
; CHECK-NEXT:      EMIT ir<%add5> = add ir<%iv>, ir<5>, vp<[[VP11]]>
; CHECK-NEXT:    Successor(s): bb7
; CHECK-EMPTY:
; CHECK-NEXT:    bb7:
; CHECK-NEXT:      BLEND ir<%phi7> = ir<%add5>/vp<[[VP11]]> ir<%add4>/vp<[[VP10]]>
...
; CHECK-NEXT:      EMIT vp<[[VP11:%[0-9]+]]> = logical-and vp<[[VP7]]>, ir<%u3>
; CHECK-NEXT:      EMIT ir<%add5> = add ir<%iv>, ir<5>, vp<[[VP11]]>
; CHECK-NEXT:      EMIT store ir<%add5>, ir<%gep>, vp<[[VP11]]>
; CHECK-NEXT:    Successor(s): bb7
; CHECK-EMPTY:
; CHECK-NEXT:    bb7:
; CHECK-NEXT:    Successor(s): bb6
