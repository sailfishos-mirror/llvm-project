...
; GFX942-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 64 -> 26
; GFX942-60:  test_waves_4
; GFX942-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 64 -> 39
; GFX942-80:  test_waves_4
; GFX942-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 64 -> 52
; GFX942-100: test_waves_4
; GFX942-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 64 -> 64

; GFX1250-40:  test_waves_4
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 256 -> 103
; GFX1250-60:  test_waves_4
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 256 -> 154
; GFX1250-80:  test_waves_4
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 256 -> 205
; GFX1250-100: test_waves_4
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 256 -> 256
...
; GFX942-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 48 -> 20
; GFX942-60:  test_waves_5
; GFX942-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 48 -> 29
; GFX942-80:  test_waves_5
; GFX942-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 48 -> 39
; GFX942-100: test_waves_5
; GFX942-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 48 -> 48

; GFX1250-40:  test_waves_5
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 192 -> 77
; GFX1250-60:  test_waves_5
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 192 -> 116
; GFX1250-80:  test_waves_5
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 192 -> 154
; GFX1250-100: test_waves_5
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 192 -> 192
...
; GFX942-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 40 -> 16
; GFX942-60:  test_waves_6
; GFX942-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 40 -> 24
; GFX942-80:  test_waves_6
; GFX942-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 40 -> 32
; GFX942-100: test_waves_6
; GFX942-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 40 -> 40

; GFX1250-40:  test_waves_6
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 160 -> 64
; GFX1250-60:  test_waves_6
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 160 -> 96
; GFX1250-80:  test_waves_6
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 160 -> 128
; GFX1250-100: test_waves_6
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 160 -> 160
...
; GFX942-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 36 -> 15
; GFX942-60:  test_waves_7
; GFX942-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 36 -> 22
; GFX942-80:  test_waves_7
; GFX942-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 36 -> 29
; GFX942-100: test_waves_7
; GFX942-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 36 -> 36

; GFX1250-40:  test_waves_7
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 144 -> 58
; GFX1250-60:  test_waves_7
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 144 -> 87
; GFX1250-80:  test_waves_7
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 144 -> 116
; GFX1250-100: test_waves_7
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 144 -> 144
...
; GFX942-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 32 -> 13
; GFX942-60:  test_waves_8
; GFX942-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 32 -> 20
; GFX942-80:  test_waves_8
; GFX942-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 32 -> 26
; GFX942-100: test_waves_8
; GFX942-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 32 -> 32

; GFX1250-40:  test_waves_8
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 128 -> 52
; GFX1250-60:  test_waves_8
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 128 -> 77
; GFX1250-80:  test_waves_8
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 128 -> 103
; GFX1250-100: test_waves_8
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 128 -> 128
...
; GFX942-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 256 -> 103
; GFX942-60:  test_waves_9
; GFX942-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 256 -> 154
; GFX942-80:  test_waves_9
; GFX942-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 256 -> 205
; GFX942-100: test_waves_9
; GFX942-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 256 -> 256

; GFX1250-40:  test_waves_9
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 112 -> 45
; GFX1250-60:  test_waves_9
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 112 -> 68
; GFX1250-80:  test_waves_9
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 112 -> 90
; GFX1250-100: test_waves_9
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 112 -> 112
...
; GFX1250-40:  Applied VGPR excess threshold 40%, VGPRExcessLimit: 96 -> 39
; GFX1250-60:  test_waves_10
; GFX1250-60:  Applied VGPR excess threshold 60%, VGPRExcessLimit: 96 -> 58
; GFX1250-80:  test_waves_10
; GFX1250-80:  Applied VGPR excess threshold 80%, VGPRExcessLimit: 96 -> 77
; GFX1250-100: test_waves_10
; GFX1250-100: Applied VGPR excess threshold 100%, VGPRExcessLimit: 96 -> 96
