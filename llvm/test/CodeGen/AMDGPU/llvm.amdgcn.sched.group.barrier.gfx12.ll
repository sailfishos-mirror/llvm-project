...
; COEXEC-NEXT:    v_dual_add_nc_u32 v4, s0, v0 :: v_dual_add_nc_u32 v49, s1, v0
; COEXEC-NEXT:    v_mov_b32_e32 v50, s1
; COEXEC-NEXT:    ds_load_b128 v[8:11], v4
; COEXEC-NEXT:    ds_load_b128 v[12:15], v4 offset:512
; COEXEC-NEXT:    ds_load_b128 v[16:19], v4 offset:1536
; COEXEC-NEXT:    ds_load_b128 v[20:23], v4 offset:5120
; COEXEC-NEXT:    ds_load_b128 v[24:27], v4 offset:3072
...
; COEXEC-NEXT:    v_mov_b64_e32 v[42:43], v[26:27]
; COEXEC-NEXT:    v_mov_b64_e32 v[40:41], v[24:25]
; COEXEC-NEXT:    v_mov_b64_e32 v[46:47], v[22:23]
; COEXEC-NEXT:    v_mov_b64_e32 v[44:45], v[20:21]
...
; COEXEC-NEXT:    v_swmmac_f16_16x16x32_f16 v[40:43], v[24:27], v[0:7], v48
; COEXEC-NEXT:    v_swmmac_f16_16x16x32_f16 v[44:47], v[20:23], v[0:7], v48
...
; COEXEC-NEXT:    v_lshl_add_u32 v17, v0, 5, s0
; COEXEC-NEXT:    v_lshl_add_u32 v18, v0, 4, s1
; COEXEC-NEXT:    v_mov_b32_e32 v19, s1
; COEXEC-NEXT:    ds_load_b128 v[8:11], v17 offset:1024
; COEXEC-NEXT:    ds_load_b128 v[4:7], v17 offset:16
; COEXEC-NEXT:    ds_load_b128 v[0:3], v17
...
; COEXEC-NEXT:    ds_store_b128 v18, v[12:15]
; COEXEC-NEXT:    ds_load_b128 v[12:15], v17 offset:2560
...
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_mov_b64_e32 v[8:9], v[12:13]
; COEXEC-NEXT:    v_mov_b64_e32 v[10:11], v[14:15]
; COEXEC-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; COEXEC-NEXT:    v_swmmac_f16_16x16x32_f16 v[8:11], v[12:15], v[0:7], v16
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; COEXEC-NEXT:    ds_store_b128 v19, v[8:11] offset:512
; COEXEC-NEXT:    ds_load_b128 v[8:11], v17 offset:4608
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000200) size(1) SyncID(0)
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000100) size(1) SyncID(0)
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_mov_b64_e32 v[14:15], v[10:11]
...
; COEXEC-NEXT:    v_swmmac_f16_16x16x32_f16 v[12:15], v[8:11], v[0:7], v16
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; COEXEC-NEXT:    ds_store_b128 v19, v[12:15] offset:1024
; COEXEC-NEXT:    ds_load_b128 v[12:15], v17 offset:7168
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000200) size(1) SyncID(0)
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000100) size(1) SyncID(0)
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_mov_b64_e32 v[8:9], v[12:13]
...
; COEXEC-NEXT:    v_swmmac_f16_16x16x32_f16 v[8:11], v[12:15], v[0:7], v16
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; COEXEC-NEXT:    ds_store_b128 v19, v[8:11] offset:1536
; COEXEC-NEXT:    ds_load_b128 v[8:11], v17 offset:10240
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000200) size(1) SyncID(0)
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000100) size(1) SyncID(0)
; COEXEC-NEXT:    s_wait_dscnt 0x0
; COEXEC-NEXT:    v_mov_b64_e32 v[14:15], v[10:11]
...
; COEXEC-NEXT:    v_swmmac_f16_16x16x32_f16 v[12:15], v[8:11], v[0:7], v16
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; COEXEC-NEXT:    ds_store_b128 v19, v[12:15] offset:2048
; COEXEC-NEXT:    ; sched_group_barrier mask(0x00000200) size(1) SyncID(0)
; COEXEC-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
