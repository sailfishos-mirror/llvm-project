...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00--amdpal -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=CHECK,DAGISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00--amdpal -mattr=-real-true16 < %s | FileCheck %s --check-prefixes=CHECK,DAGISEL
; RUN: llc -global-isel=1 -mtriple=amdgpu12.00--amdpal -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=CHECK,GISEL
; RUN: llc -global-isel=1 -mtriple=amdgpu12.00--amdpal -mattr=-real-true16 < %s | FileCheck %s --check-prefixes=CHECK,GISEL
...
; DAGISEL-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL-NEXT:    v_mov_b32_e32 v3, s32
; DAGISEL-NEXT:    s_wait_storecnt 0x0
; DAGISEL-NEXT:    scratch_store_b32 v3, v0, off scope:SCOPE_SYS
; DAGISEL-NEXT:    s_wait_storecnt 0x0
; DAGISEL-NEXT:    v_mov_b32_e32 v0, s33
; DAGISEL-NEXT:    v_add_nc_u32_e32 v4, s1, v3
; DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; DAGISEL-NEXT:    v_readfirstlane_b32 s32, v4
...
; DAGISEL-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL-NEXT:    v_mov_b32_e32 v2, s32
; DAGISEL-NEXT:    v_mov_b32_e32 v4, s33
; DAGISEL-NEXT:    s_wait_storecnt 0x0
; DAGISEL-NEXT:    scratch_store_b32 v2, v8, off scope:SCOPE_SYS
; DAGISEL-NEXT:    s_wait_storecnt 0x0
; DAGISEL-NEXT:    scratch_store_b32 v2, v4, off scope:SCOPE_SYS
; DAGISEL-NEXT:    s_wait_storecnt 0x0
; DAGISEL-NEXT:    v_add_nc_u32_e32 v3, s1, v2
; DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
