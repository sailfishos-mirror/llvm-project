...
; VI-NEXT:  ; %bb.1: ; %cmp.false
; VI-NEXT:    ; kill: def $vgpr3 killed $sgpr4 killed $exec
...
; GFX9-NEXT:  ; %bb.1: ; %cmp.false
; GFX9-NEXT:    ; kill: def $vgpr3 killed $sgpr4 killed $exec
...
; GFX9-NEXT:    ; kill: def $vgpr9 killed $sgpr4 killed $exec
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr3 killed $sgpr0 killed $exec
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[13:14], 24, v[2:3]
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[15:16], 24, v[0:1]
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v12.h, v2.h
...
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v12, 3, v2
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr13 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v11
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[15:16], 24, v[10:11]
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[13:14], 24, v[12:13]
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v9, 8, v12
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v12.h
...
; GFX11-FAKE16-NEXT:    ; kill: def $vgpr3 killed $sgpr0 killed $exec
...
; GFX11-FAKE16-NEXT:    ; kill: def $vgpr9 killed $sgpr0 killed $exec
...
; VI-NEXT:    s_lshr_b32 s19, s5, 16
; VI-NEXT:    s_lshr_b32 s20, s5, 8
; VI-NEXT:    s_lshr_b32 s21, s4, 16
; VI-NEXT:    s_lshr_b32 s22, s4, 8
...
; GFX9-NEXT:    s_lshr_b32 s14, s8, 8
; GFX9-NEXT:    s_lshr_b32 s15, s5, 24
; GFX9-NEXT:    s_lshr_b32 s19, s5, 16
; GFX9-NEXT:    s_lshr_b32 s20, s5, 8
; GFX9-NEXT:    s_lshr_b32 s21, s4, 16
; GFX9-NEXT:    s_lshr_b32 s22, s4, 8
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b32 s7, s17, exec_lo
...
; GFX9-NEXT:    ; kill: def $vgpr7 killed $sgpr4 killed $exec
; GFX9-NEXT:    v_mov_b32_e32 v0, v4
; GFX9-NEXT:    v_mov_b32_e32 v1, v5
; GFX9-NEXT:    v_mov_b32_e32 v2, v6
...
; GFX11-NEXT:    ; kill: def $vgpr7 killed $sgpr0 killed $exec
; GFX11-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
...
; GFX11-TRUE16-NEXT:    v_add_f32_e32 v12, 1.0, v2
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr13 killed $sgpr0 killed $exec
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr17 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v11
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[12:13], 24, v[10:11]
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3)
