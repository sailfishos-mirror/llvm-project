...
; GCN-NEXT:    buffer_store_short v0, v[1:2], s[8:11], 0 addr64
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GCN-NEXT:    buffer_load_dwordx4 v[0:3], v[3:4], s[4:7], 0 addr64
...
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    s_mov_b32 s6, 0
; GCN-NEXT:    v_lshlrev_b32_e32 v4, 5, v0
; GCN-NEXT:    v_mov_b32_e32 v5, 0
; GCN-NEXT:    v_lshlrev_b32_e32 v8, 1, v0
; GCN-NEXT:    v_mov_b32_e32 v9, v5
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GCN-NEXT:    buffer_load_dwordx4 v[0:3], v[4:5], s[4:7], 0 addr64
; GCN-NEXT:    s_mov_b64 s[2:3], s[6:7]
; GCN-NEXT:    buffer_load_dwordx4 v[4:7], v[4:5], s[4:7], 0 addr64 offset:16
; GCN-NEXT:    s_cmp_eq_u32 s8, 1
...
; GCN-NEXT:    v_lshrrev_b32_e32 v15, 16, v5
; GCN-NEXT:    v_lshrrev_b32_e32 v16, 16, v6
; GCN-NEXT:    v_lshrrev_b32_e32 v17, 16, v7
...
; GCN-NEXT:    buffer_store_short v0, v[8:9], s[0:3], 0 addr64
; GCN-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
  %in.gep = getelementptr inbounds <16 x i16>, ptr addrspace(1) %in, i64 %tid.ext
