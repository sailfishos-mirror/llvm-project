...
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.0a -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefixes=GFX90A-VGPR-GISEL %s
...
; RUN: llc -global-isel=1 -verify-machineinstrs -mtriple=amdgpu9.42 -amdgpu-mfma-vgpr-form < %s | FileCheck -enable-var-scope --check-prefixes=GFX942-VGPR-GISEL %s
...
; GFX90A-GISEL-NEXT:    s_mov_b32 s38, 2
...
; GFX90A-GISEL-NEXT:    v_pk_mov_b32 v[34:35], s[38:39], s[38:39] op_sel:[0,1]
; GFX90A-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-GISEL-NEXT:    s_mov_b32 s38, 2
...
; GFX942-GISEL-NEXT:    v_mov_b64_e32 v[34:35], s[38:39]
; GFX942-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-VGPR-GISEL-NEXT:    s_mov_b32 s38, 2
; GFX90A-VGPR-GISEL-NEXT:    s_mov_b32 s39, s37
...
; GFX90A-VGPR-GISEL-NEXT:    v_pk_mov_b32 v[34:35], s[38:39], s[38:39] op_sel:[0,1]
; GFX90A-VGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-VGPR-GISEL-NEXT:    s_mov_b32 s38, 2
...
; GFX942-VGPR-GISEL-NEXT:    v_mov_b64_e32 v[34:35], s[38:39]
; GFX942-VGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-GISEL-NEXT:    s_mov_b32 s20, 2
; GFX90A-GISEL-NEXT:    s_mov_b32 s21, s19
; GFX90A-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-GISEL-NEXT:    s_load_dwordx16 s[0:15], s[16:17], 0x0
; GFX90A-GISEL-NEXT:    v_pk_mov_b32 v[18:19], s[20:21], s[20:21] op_sel:[0,1]
; GFX90A-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-GISEL-NEXT:    v_pk_mov_b32 v[0:1], s[0:1], s[0:1] op_sel:[0,1]
; GFX90A-GISEL-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-GISEL-NEXT:    v_pk_mov_b32 v[4:5], s[4:5], s[4:5] op_sel:[0,1]
...
; GFX942-GISEL-NEXT:    s_mov_b32 s20, 2
...
; GFX90A-VGPR-GISEL-NEXT:    s_mov_b32 s20, 2
; GFX90A-VGPR-GISEL-NEXT:    s_mov_b32 s21, s19
; GFX90A-VGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-VGPR-GISEL-NEXT:    s_load_dwordx16 s[0:15], s[16:17], 0x0
; GFX90A-VGPR-GISEL-NEXT:    v_pk_mov_b32 v[18:19], s[20:21], s[20:21] op_sel:[0,1]
; GFX90A-VGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-VGPR-GISEL-NEXT:    v_pk_mov_b32 v[0:1], s[0:1], s[0:1] op_sel:[0,1]
; GFX90A-VGPR-GISEL-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-VGPR-GISEL-NEXT:    v_pk_mov_b32 v[4:5], s[4:5], s[4:5] op_sel:[0,1]
...
; GFX942-VGPR-GISEL-NEXT:    s_mov_b32 s20, 2
; GFX942-VGPR-GISEL-NEXT:    s_mov_b32 s21, s19
; GFX942-VGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-VGPR-GISEL-NEXT:    s_load_dwordx16 s[0:15], s[16:17], 0x0
; GFX942-VGPR-GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[20:21]
; GFX942-VGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-VGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-VGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-VGPR-GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[4:5]
