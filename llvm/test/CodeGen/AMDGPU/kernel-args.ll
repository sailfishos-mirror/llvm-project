...
; SI-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 offset:38
; SI-NEXT:    buffer_load_ushort v1, off, s[4:7], 0 offset:42
; SI-NEXT:    buffer_load_ushort v2, off, s[4:7], 0 offset:40
; SI-NEXT:    s_waitcnt lgkmcnt(0)
