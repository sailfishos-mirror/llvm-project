...
; SDAG-NEXT:    v_add_nc_u32_e32 v0, v1, v0
; SDAG-NEXT:    global_store_b32 v2, v0, s[2:3] offset:4 scale_offset
; SDAG-NEXT:    s_endpgm
;
...
; GISEL-NEXT:    s_mov_b32 s9, s14
; GISEL-NEXT:    s_mov_b32 s19, s15
; GISEL-NEXT:  .LBB2_1: ; %loop_body
; GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GISEL-NEXT:    s_add_co_u32 s8, s13, 8
; GISEL-NEXT:    s_clause 0x1
...
; GISEL-NEXT:    s_wait_kmcnt 0x0
; GISEL-NEXT:    s_add_co_i32 s9, s16, s17
