...
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, 0
; GCN-NEXT:    s_movk_i32 s20, 0xff80
...
; GCN-NEXT:    s_mov_b64 s[4:5], s[12:13]
; GCN-NEXT:    s_mov_b64 s[16:17], s[14:15]
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    buffer_load_sbyte v2, v[0:1], s[4:7], 0 addr64
; GCN-NEXT:    buffer_load_sbyte v3, v[0:1], s[0:3], 0 addr64
...
; GCN-NEXT:    v_med3_i32 v2, v2, s20, v5
; GCN-NEXT:    s_mov_b64 s[10:11], s[2:3]
; GCN-NEXT:    buffer_store_byte v2, v[0:1], s[8:11], 0 addr64
; GCN-NEXT:    s_endpgm
;
...
; GCN-NEXT:    s_addc_u32 s25, s25, 0
; GCN-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x9
; GCN-NEXT:    s_load_dword s1, s[4:5], 0x11
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_mov_b32 s6, 0
; GCN-NEXT:    s_mov_b32 s7, s3
; GCN-NEXT:    s_mov_b64 s[18:19], s[6:7]
; GCN-NEXT:    s_mov_b64 s[22:23], s[6:7]
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s0, s8
; GCN-NEXT:    s_add_i32 s4, s1, 4
; GCN-NEXT:    v_mov_b32_e32 v0, s1
; GCN-NEXT:    v_mov_b32_e32 v1, s4
; GCN-NEXT:    buffer_load_dword v1, v1, s[24:27], 0 offen
; GCN-NEXT:    buffer_load_dword v0, v0, s[24:27], 0 offen
; GCN-NEXT:    s_mov_b64 s[4:5], s[10:11]
; GCN-NEXT:    s_mov_b64 s[16:17], s[12:13]
; GCN-NEXT:    s_mov_b64 s[20:21], s[14:15]
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    buffer_load_sbyte v2, v[0:1], s[4:7], 0 addr64
