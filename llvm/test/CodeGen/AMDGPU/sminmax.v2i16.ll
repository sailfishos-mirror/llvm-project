...
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v4, v3, s[0:1]
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_or_b32_e32 v1, s0, v4
...
; VI-NEXT:    v_or_b32_sdwa v5, v6, v9 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-NEXT:    v_lshlrev_b32_e32 v6, 16, v7
; VI-NEXT:    v_lshlrev_b32_e32 v7, 1, v8
; VI-NEXT:    s_cselect_b32 s0, 1, 0
; VI-NEXT:    flat_store_dword v[0:1], v5
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_or_b32_e32 v0, s0, v7
