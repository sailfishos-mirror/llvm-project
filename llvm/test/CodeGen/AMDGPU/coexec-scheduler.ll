...
; COEXEC-NEXT:    v_dual_mov_b32 v8, v0 :: v_dual_mov_b32 v29, v0
; COEXEC-NEXT:    v_mov_b32_e32 v14, v0
; COEXEC-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; COEXEC-NEXT:    v_cmp_ne_u32_e64 s0, 1, v7
; COEXEC-NEXT:    v_dual_mov_b32 v7, v0 :: v_dual_mov_b32 v22, v0
; COEXEC-NEXT:    v_dual_mov_b32 v30, v0 :: v_dual_mov_b32 v15, v0
; COEXEC-NEXT:    v_dual_mov_b32 v23, v0 :: v_dual_mov_b32 v31, v0
...
; COEXEC-NEXT:    ds_load_tr16_b128 v[48:51], v156 offset:256
; COEXEC-NEXT:    ds_load_tr16_b128 v[56:59], v124 offset:256
; COEXEC-NEXT:    ds_load_tr16_b128 v[52:55], v156 offset:320
; COEXEC-NEXT:    ds_load_tr16_b128 v[60:63], v124 offset:320
