...
; i8 -> i16 uniform extending loads (UniS16)
...
define amdgpu_ps void @sextload_P3_i8_to_i16(ptr addrspace(3) inreg %ptra, ptr addrspace(1) %out) {
; GFX11-LABEL: sextload_P3_i8_to_i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v2, s0
; GFX11-NEXT:    ds_load_i8_d16 v2, v2
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v2
; GFX11-NEXT:    s_add_i32 s0, s0, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: sextload_P3_i8_to_i16:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v2, s0
; GFX12-NEXT:    ds_load_i8_d16 v2, v2
...
define amdgpu_ps void @zextload_P3_i8_to_i16(ptr addrspace(3) inreg %ptra, ptr addrspace(1) %out) {
; GFX11-LABEL: zextload_P3_i8_to_i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: zextload_P3_i8_to_i16:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v2, s0
