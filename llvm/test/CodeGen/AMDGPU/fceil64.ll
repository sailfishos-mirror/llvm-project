...
; SI-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[6:7], 0
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[12:13], s[4:5], 0
; SI-NEXT:    s_add_i32 s17, s14, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[14:15], s[8:9], s17
...
; SI-NEXT:    s_and_b64 s[4:5], s[12:13], vcc
; SI-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; SI-NEXT:    s_cselect_b32 s4, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v1, s4
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_u32 s22, s3, 0xb0014
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[20:21], s[4:5], 0
; SI-NEXT:    s_add_i32 s25, s22, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[22:23], s[12:13], s25
...
; SI-NEXT:    v_add_f64 v[4:5], s[22:23], v[0:1]
...
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[0:1], v[1:2]
...
; SI-NEXT:    s_lshr_b64 s[0:1], s[12:13], s2
...
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[6:7], v[6:7]
...
; SI-NEXT:    s_lshr_b64 s[0:1], s[12:13], s3
; SI-NEXT:    s_andn2_b64 s[0:1], s[4:5], s[0:1]
...
; SI-NEXT:    s_and_b32 s42, s3, 0x80000000
...
; SI-NEXT:    s_lshr_b64 s[40:41], s[20:21], s33
; SI-NEXT:    s_andn2_b64 s[40:41], s[2:3], s[40:41]
; SI-NEXT:    s_cmp_lt_i32 s33, 0
; SI-NEXT:    s_cselect_b32 s40, 0, s40
; SI-NEXT:    s_cselect_b32 s41, s42, s41
; SI-NEXT:    s_cmp_gt_i32 s33, 51
; SI-NEXT:    s_cselect_b32 s41, s3, s41
; SI-NEXT:    s_cselect_b32 s40, s2, s40
...
; SI-NEXT:    s_addk_i32 s3, 0xfc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[20:21], s3
; SI-NEXT:    s_andn2_b64 s[0:1], s[4:5], s[0:1]
; SI-NEXT:    s_cmp_lt_i32 s3, 0
; SI-NEXT:    s_cselect_b32 s0, 0, s0
; SI-NEXT:    s_cselect_b32 s1, s6, s1
...
; SI-NEXT:    v_mov_b32_e32 v5, s2
; SI-NEXT:    v_add_f64 v[5:6], s[0:1], v[4:5]
; SI-NEXT:    s_addk_i32 s3, 0xfc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[20:21], s3
...
; SI-NEXT:    v_mov_b32_e32 v6, s1
; SI-NEXT:    v_mov_b32_e32 v5, s0
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[14:15], v[5:6]
...
; SI-NEXT:    s_and_b64 s[2:3], s[38:39], vcc
; SI-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; SI-NEXT:    s_cselect_b32 s2, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v5, s2
; SI-NEXT:    v_add_f64 v[4:5], s[0:1], v[4:5]
...
; SI-NEXT:    v_cmp_gt_f64_e64 s[2:3], s[10:11], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[6:7], s[8:9], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[24:25], s[14:15], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[34:35], s[12:13], 0
; SI-NEXT:    v_cmp_gt_f64_e64 s[40:41], s[18:19], 0
; SI-NEXT:    s_add_i32 s30, s0, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[28:29], s30
; SI-NEXT:    s_andn2_b64 s[0:1], s[10:11], s[0:1]
...
; SI-NEXT:    s_lshr_b64 s[2:3], s[28:29], s27
...
; SI-NEXT:    s_cselect_b32 s43, s9, s3
; SI-NEXT:    s_cselect_b32 s42, s8, s2
...
; SI-NEXT:    s_cselect_b32 s3, s7, s3
; SI-NEXT:    s_cmp_gt_i32 s8, 51
; SI-NEXT:    s_cselect_b32 s31, s13, s3
; SI-NEXT:    s_cselect_b32 s30, s12, s2
...
; SI-NEXT:    s_and_b32 s7, s19, 0x80000000
; SI-NEXT:    s_add_i32 s8, s2, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[2:3], s[28:29], s8
...
; SI-NEXT:    s_cselect_b32 s3, s7, s3
; SI-NEXT:    s_cmp_gt_i32 s8, 51
; SI-NEXT:    s_cselect_b32 s39, s19, s3
; SI-NEXT:    s_cselect_b32 s38, s18, s2
; SI-NEXT:    v_mov_b32_e32 v0, s38
; SI-NEXT:    v_mov_b32_e32 v1, s39
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[18:19], v[0:1]
; SI-NEXT:    s_and_b64 s[2:3], s[40:41], vcc
; SI-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; SI-NEXT:    s_cselect_b32 s45, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s2, s17, 0xb0014
; SI-NEXT:    s_and_b32 s7, s17, 0x80000000
; SI-NEXT:    s_add_i32 s8, s2, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[2:3], s[28:29], s8
; SI-NEXT:    s_andn2_b64 s[2:3], s[16:17], s[2:3]
; SI-NEXT:    s_cmp_lt_i32 s8, 0
; SI-NEXT:    s_cselect_b32 s9, 0, s2
; SI-NEXT:    s_cselect_b32 s7, s7, s3
; SI-NEXT:    v_cmp_gt_f64_e64 s[2:3], s[16:17], 0
; SI-NEXT:    s_cmp_gt_i32 s8, 51
; SI-NEXT:    s_cselect_b32 s41, s17, s7
; SI-NEXT:    s_cselect_b32 s40, s16, s9
; SI-NEXT:    v_mov_b32_e32 v0, s40
; SI-NEXT:    v_mov_b32_e32 v1, s41
...
; SI-NEXT:    s_and_b32 s8, s23, 0x80000000
; SI-NEXT:    s_cmp_lt_i32 s7, 0
; SI-NEXT:    s_cselect_b32 s3, s8, s3
; SI-NEXT:    s_cselect_b32 s2, 0, s2
; SI-NEXT:    s_cmp_gt_i32 s7, 51
; SI-NEXT:    s_cselect_b32 s35, s23, s3
; SI-NEXT:    s_cselect_b32 s34, s22, s2
...
; SI-NEXT:    s_add_i32 s7, s2, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[2:3], s[28:29], s7
; SI-NEXT:    s_andn2_b64 s[2:3], s[20:21], s[2:3]
...
; SI-NEXT:    s_cselect_b32 s16, s20, s2
...
; SI-NEXT:    v_add_f64 v[2:3], s[0:1], v[12:13]
...
; SI-NEXT:    v_add_f64 v[6:7], s[36:37], v[12:13]
; SI-NEXT:    v_cmp_gt_f64_e64 s[22:23], s[0:1], 0
; SI-NEXT:    v_mov_b32_e32 v13, s44
; SI-NEXT:    v_add_f64 v[4:5], s[30:31], v[12:13]
; SI-NEXT:    v_cmp_gt_f64_e64 s[30:31], s[6:7], 0
; SI-NEXT:    v_mov_b32_e32 v13, s45
; SI-NEXT:    v_cmp_gt_f64_e64 s[36:37], s[4:5], 0
; SI-NEXT:    v_add_f64 v[10:11], s[38:39], v[12:13]
; SI-NEXT:    v_cmp_gt_f64_e64 s[38:39], s[10:11], 0
; SI-NEXT:    v_mov_b32_e32 v13, s46
; SI-NEXT:    v_add_f64 v[8:9], s[40:41], v[12:13]
; SI-NEXT:    v_cmp_gt_f64_e64 s[40:41], s[8:9], 0
; SI-NEXT:    v_mov_b32_e32 v13, s47
; SI-NEXT:    v_cmp_gt_f64_e64 s[42:43], s[14:15], 0
; SI-NEXT:    v_add_f64 v[15:16], s[34:35], v[12:13]
; SI-NEXT:    v_cmp_gt_f64_e64 s[34:35], s[12:13], 0
...
; SI-NEXT:    v_add_f64 v[13:14], s[16:17], v[12:13]
; SI-NEXT:    s_addk_i32 s19, 0xfc01
; SI-NEXT:    s_lshr_b64 s[16:17], s[28:29], s19
; SI-NEXT:    buffer_store_dwordx4 v[13:16], off, s[24:27], 0 offset:48
...
; SI-NEXT:    s_add_i32 s16, s3, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[2:3], s[28:29], s16
; SI-NEXT:    s_andn2_b64 s[2:3], s[0:1], s[2:3]
...
; SI-NEXT:    s_and_b64 s[0:1], s[22:23], vcc
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s0, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s1, s7, 0xb0014
; SI-NEXT:    s_and_b32 s16, s7, 0x80000000
...
; SI-NEXT:    s_add_i32 s2, s1, 0xfffffc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[28:29], s2
...
; SI-NEXT:    s_and_b32 s4, s11, 0x80000000
; SI-NEXT:    v_mov_b32_e32 v13, s2
; SI-NEXT:    v_add_f64 v[4:5], s[0:1], v[12:13]
; SI-NEXT:    s_addk_i32 s3, 0xfc01
; SI-NEXT:    s_lshr_b64 s[0:1], s[28:29], s3
...
; SI-NEXT:    v_mov_b32_e32 v5, s1
; SI-NEXT:    v_mov_b32_e32 v4, s0
; SI-NEXT:    v_cmp_lg_f64_e32 vcc, s[14:15], v[4:5]
; SI-NEXT:    s_and_b64 s[2:3], s[42:43], vcc
; SI-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; SI-NEXT:    s_cselect_b32 s2, 0x3ff00000, 0
; SI-NEXT:    s_bfe_u32 s3, s13, 0xb0014
; SI-NEXT:    s_and_b32 s4, s13, 0x80000000
