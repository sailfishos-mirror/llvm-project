...
; GFX8-NEXT:    s_and_b32 s4, s16, 0xff
; GFX8-NEXT:    s_and_b32 s5, s17, 0xff
; GFX8-NEXT:    s_and_b32 s5, s5, 0xffff
; GFX8-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX8-NEXT:    s_max_u32 s4, s4, s5
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s4, s17, 0xffff
; GFX9-NEXT:    s_and_b32 s5, s16, 0xffff
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s4, s17, 0xffff
; GFX10-NEXT:    s_and_b32 s5, s16, 0xffff
; GFX10-NEXT:    s_max_u32 s5, s5, s4
; GFX10-NEXT:    s_sub_i32 s4, s5, s4
; GFX10-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    s_and_b32 s4, s16, 0xffff
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s4, s16, 0xffff
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s4, s16, 0xffff
...
; GFX8-NEXT:    s_max_u32 s6, s6, s5
; GFX8-NEXT:    s_sub_i32 s5, s6, s5
; GFX8-NEXT:    s_and_b32 s6, s18, 0xffff
; GFX8-NEXT:    s_and_b32 s7, s16, 0xffff
...
; GFX8-NEXT:    s_max_u32 s6, s6, s5
; GFX8-NEXT:    s_sub_i32 s5, s6, s5
; GFX8-NEXT:    s_and_b32 s6, s19, 0xffff
; GFX8-NEXT:    s_and_b32 s7, s17, 0xffff
; GFX8-NEXT:    s_max_u32 s7, s7, s6
; GFX8-NEXT:    s_sub_i32 s6, s7, s6
