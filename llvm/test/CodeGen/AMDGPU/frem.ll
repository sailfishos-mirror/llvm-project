...
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v1|, s6
...
; SI-NEXT:    s_cselect_b32 s6, s2, 0
; SI-NEXT:    s_add_i32 s2, s6, -1
...
; SI-NEXT:    v_div_scale_f32 v4, s[8:9], v1, v1, 1.0
...
; SI-NEXT:    s_and_b32 s2, s4, 0x8000
...
; CI-NEXT:    buffer_load_ushort v0, off, s[8:11], 0 offset:8
...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_readfirstlane_b32 s4, v1
; SI-NEXT:    buffer_load_dword v0, off, s[8:11], 0 offset:16
; SI-NEXT:    v_cvt_f32_f16_e64 v2, |v1|
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cvt_f32_f16_e64 v1, |v0|
; SI-NEXT:    v_cmp_ngt_f32_e32 vcc, v2, v1
...
; SI-NEXT:    s_and_b32 s5, s4, 0xffff8000
; SI-NEXT:    v_cmp_eq_f32_e32 vcc, v2, v1
; SI-NEXT:    s_and_b64 s[2:3], vcc, exec
; SI-NEXT:    s_cselect_b32 s5, s5, s4
; SI-NEXT:    s_mov_b64 vcc, exec
...
; SI-NEXT:  ; %bb.2:
; SI-NEXT:    v_mov_b32_e32 v1, s5
; SI-NEXT:    s_branch .LBB9_9
; SI-NEXT:  .LBB9_3:
; SI-NEXT:    ; implicit-def: $sgpr5
; SI-NEXT:    s_mov_b64 vcc, 0
; SI-NEXT:  .LBB9_4: ; %frem.compute19
; SI-NEXT:    s_mov_b32 s6, 0x7f800000
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v2|, s6
; SI-NEXT:    v_frexp_exp_i32_f32_e32 v3, v2
; SI-NEXT:    s_and_b64 s[2:3], vcc, exec
...
; SI-NEXT:    v_cvt_f16_f32_e32 v1, v1
; SI-NEXT:    v_and_b32_e32 v1, 0x7fff, v1
; SI-NEXT:    s_and_b32 s2, s4, 0xffff8000
; SI-NEXT:    v_or_b32_e32 v1, s2, v1
...
; SI-NEXT:    v_cvt_f32_f16_e64 v3, |v2|
; SI-NEXT:    v_cmp_ngt_f32_e32 vcc, v4, v3
; SI-NEXT:    s_cbranch_vccz .LBB9_13
...
; SI-NEXT:    s_mov_b64 vcc, exec
; SI-NEXT:    s_cbranch_execz .LBB9_14
; SI-NEXT:  ; %bb.12:
; SI-NEXT:    v_mov_b32_e32 v3, s6
; SI-NEXT:    s_branch .LBB9_19
; SI-NEXT:  .LBB9_13:
; SI-NEXT:    ; implicit-def: $sgpr6
; SI-NEXT:    s_mov_b64 vcc, 0
; SI-NEXT:  .LBB9_14: ; %frem.compute
; SI-NEXT:    s_mov_b32 s7, 0x7f800000
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v4|, s7
...
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v3|, s7
...
; SI-NEXT:    s_sub_i32 s3, s6, s7
; SI-NEXT:    s_add_i32 s3, s3, 11
; SI-NEXT:  .LBB9_16: ; %frem.loop_body
; SI-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; SI-NEXT:  .LBB9_18: ; %frem.loop_exit
; SI-NEXT:    s_add_i32 s3, s3, -10
; SI-NEXT:    v_ldexp_f32_e64 v4, v4, s3
...
; SI-NEXT:    s_and_b32 s4, s5, 0x7fff
; SI-NEXT:    s_cmpk_eq_i32 s4, 0x7c00
; SI-NEXT:    s_cselect_b64 s[4:5], -1, 0
; SI-NEXT:    s_or_b64 vcc, s[4:5], vcc
...
; CI-NEXT:    buffer_load_dword v0, off, s[8:11], 0 offset:16
; CI-NEXT:    s_waitcnt vmcnt(1)
; CI-NEXT:    v_readfirstlane_b32 s4, v1
; CI-NEXT:    v_cvt_f32_f16_e64 v2, |v1|
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_cvt_f32_f16_e64 v1, |v0|
; CI-NEXT:    v_cmp_ngt_f32_e32 vcc, v2, v1
; CI-NEXT:    s_cbranch_vccz .LBB9_3
; CI-NEXT:  ; %bb.1: ; %frem.else20
; CI-NEXT:    s_and_b32 s5, s4, 0xffff8000
; CI-NEXT:    v_cmp_eq_f32_e32 vcc, v2, v1
; CI-NEXT:    s_and_b64 s[2:3], vcc, exec
; CI-NEXT:    s_cselect_b32 s5, s5, s4
; CI-NEXT:    s_cbranch_execz .LBB9_4
; CI-NEXT:  ; %bb.2:
; CI-NEXT:    v_mov_b32_e32 v1, s5
; CI-NEXT:    s_branch .LBB9_9
; CI-NEXT:  .LBB9_3:
; CI-NEXT:    ; implicit-def: $sgpr5
; CI-NEXT:  .LBB9_4: ; %frem.compute19
; CI-NEXT:    v_frexp_exp_i32_f32_e32 v6, v2
; CI-NEXT:    v_frexp_mant_f32_e32 v2, v2
; CI-NEXT:    v_ldexp_f32_e64 v4, v2, 11
; CI-NEXT:    v_frexp_mant_f32_e32 v2, v1
...
; CI-NEXT:    v_div_scale_f32 v10, s[2:3], v4, v4, 1.0
...
; CI-NEXT:    s_cbranch_vccnz .LBB9_18
; CI-NEXT:  ; %bb.15: ; %frem.loop_body.preheader
; CI-NEXT:    v_sub_i32_e32 v5, vcc, v8, v9
; CI-NEXT:    v_add_i32_e32 v5, vcc, 11, v5
; CI-NEXT:  .LBB9_16: ; %frem.loop_body
; CI-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; CI-NEXT:    s_cbranch_vccnz .LBB9_16
; CI-NEXT:  ; %bb.17: ; %Flow
; CI-NEXT:    v_mov_b32_e32 v6, v8
; CI-NEXT:  .LBB9_18: ; %frem.loop_exit
...
; CI-NEXT:    s_and_b32 s2, s5, 0x8000
; CI-NEXT:    v_and_b32_e32 v3, 0x7fff, v3
; CI-NEXT:    v_or_b32_e32 v3, s2, v3
; CI-NEXT:  .LBB9_19: ; %Flow54
; CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; CI-NEXT:    s_and_b32 s2, s4, 0x7fff
; CI-NEXT:    s_cmpk_eq_i32 s2, 0x7c00
; CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; CI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v0
; CI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; CI-NEXT:    s_or_b64 vcc, s[2:3], vcc
...
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v2|, s7
...
; SI-NEXT:    s_add_i32 s3, s3, s6
; SI-NEXT:    v_div_scale_f32 v4, vcc, 1.0, v2, 1.0
; SI-NEXT:    v_div_scale_f32 v5, s[8:9], v2, v2, 1.0
; SI-NEXT:    v_rcp_f32_e32 v6, v5
; SI-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
; SI-NEXT:    v_fma_f32 v7, -v5, v6, 1.0
; SI-NEXT:    v_fma_f32 v6, v7, v6, v6
...
; SI-NEXT:    s_and_b32 s2, s5, 0xffff8000
; SI-NEXT:    v_or_b32_e32 v3, s2, v2
...
; SI-NEXT:  ; %bb.10:
; SI-NEXT:    v_cvt_f32_f16_e64 v6, |s7|
...
; SI-NEXT:    s_and_b32 s8, s7, 0x8000
; SI-NEXT:    v_cmp_eq_f32_e32 vcc, v6, v5
; SI-NEXT:    s_and_b64 s[2:3], vcc, exec
; SI-NEXT:    s_cselect_b32 s8, s8, s7
; SI-NEXT:    s_mov_b64 vcc, exec
...
; SI-NEXT:    s_and_b64 s[2:3], vcc, exec
; SI-NEXT:    v_readfirstlane_b32 s2, v5
; SI-NEXT:    s_cselect_b32 s9, s2, 0
; SI-NEXT:    s_add_i32 s2, s9, -1
...
; SI-NEXT:    s_and_b32 s2, s7, 0x8000
; SI-NEXT:    v_or_b32_e32 v5, s2, v5
; SI-NEXT:  .LBB10_19:
; SI-NEXT:    v_cvt_f32_f16_e64 v7, |s4|
...
; SI-NEXT:    s_and_b32 s8, s4, 0xffff8000
; SI-NEXT:    v_cmp_eq_f32_e32 vcc, v7, v6
; SI-NEXT:    s_and_b64 s[2:3], vcc, exec
; SI-NEXT:    s_cselect_b32 s8, s8, s4
; SI-NEXT:    s_mov_b64 vcc, exec
...
; SI-NEXT:    s_mov_b32 s9, 0x7f800000
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v7|, s9
...
; SI-NEXT:    s_add_i32 s3, s3, -10
; SI-NEXT:    v_ldexp_f32_e64 v7, v7, s3
...
; SI-NEXT:    s_mov_b32 s9, 0x7f800000
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v8|, s9
...
; SI-NEXT:    s_add_i32 s3, s3, -10
; SI-NEXT:    v_ldexp_f32_e64 v8, v8, s3
...
; SI-NEXT:    v_ldexp_f32_e64 v7, v7, s2
; SI-NEXT:    v_cvt_f16_f32_e32 v7, v7
; SI-NEXT:    v_and_b32_e32 v7, 0x7fff, v7
; SI-NEXT:    s_and_b32 s2, s6, 0x8000
; SI-NEXT:    v_or_b32_e32 v7, s2, v7
; SI-NEXT:  .LBB10_37: ; %Flow124
; SI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; SI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v0
; SI-NEXT:    s_and_b32 s2, s5, 0x7fff
; SI-NEXT:    s_cmpk_eq_i32 s2, 0x7c00
; SI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; SI-NEXT:    s_or_b64 vcc, s[2:3], vcc
; SI-NEXT:    v_mov_b32_e32 v0, 0x7e00
; SI-NEXT:    v_cndmask_b32_e32 v3, v3, v0, vcc
; SI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; SI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v4
; SI-NEXT:    s_and_b32 s2, s7, 0x7fff
; SI-NEXT:    s_cmpk_eq_i32 s2, 0x7c00
; SI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; SI-NEXT:    s_or_b64 vcc, s[2:3], vcc
; SI-NEXT:    v_cndmask_b32_e32 v4, v5, v0, vcc
...
; SI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; SI-NEXT:    s_or_b64 vcc, s[2:3], vcc
; SI-NEXT:    v_cndmask_b32_e32 v1, v6, v0, vcc
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; SI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v2
...
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_readfirstlane_b32 s4, v1
; CI-NEXT:    v_readfirstlane_b32 s5, v0
...
; CI-NEXT:    s_and_b32 s6, s5, 0xffff8000
...
; CI-NEXT:    s_and_b32 s2, s5, 0xffff8000
; CI-NEXT:    v_and_b32_e32 v2, 0x7fff, v2
; CI-NEXT:    v_or_b32_e32 v3, s2, v2
...
; CI-NEXT:  ; %bb.10:
; CI-NEXT:    v_cvt_f32_f16_e64 v6, |s7|
...
; CI-NEXT:    s_and_b32 s8, s7, 0x8000
; CI-NEXT:    v_cmp_eq_f32_e32 vcc, v6, v5
; CI-NEXT:    s_and_b64 s[2:3], vcc, exec
; CI-NEXT:    s_cselect_b32 s8, s8, s7
; CI-NEXT:    s_cbranch_execz .LBB10_14
; CI-NEXT:  ; %bb.12:
; CI-NEXT:    v_mov_b32_e32 v5, s8
; CI-NEXT:    s_branch .LBB10_19
; CI-NEXT:  .LBB10_13:
; CI-NEXT:    ; implicit-def: $sgpr8
...
; CI-NEXT:    s_and_b32 s2, s7, 0x8000
; CI-NEXT:    v_and_b32_e32 v5, 0x7fff, v5
; CI-NEXT:    v_or_b32_e32 v5, s2, v5
; CI-NEXT:  .LBB10_19:
; CI-NEXT:    v_cvt_f32_f16_e64 v7, |s4|
...
; CI-NEXT:    s_and_b32 s8, s4, 0xffff8000
; CI-NEXT:    v_cmp_eq_f32_e32 vcc, v7, v6
; CI-NEXT:    s_and_b64 s[2:3], vcc, exec
; CI-NEXT:    s_cselect_b32 s8, s8, s4
...
; CI-NEXT:    v_div_scale_f32 v13, s[2:3], v7, v7, 1.0
...
; CI-NEXT:    v_div_scale_f32 v14, s[2:3], v8, v8, 1.0
...
; CI-NEXT:    s_and_b32 s2, s6, 0x8000
; CI-NEXT:    v_and_b32_e32 v7, 0x7fff, v7
; CI-NEXT:    v_or_b32_e32 v7, s2, v7
; CI-NEXT:  .LBB10_37: ; %Flow124
; CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; CI-NEXT:    s_and_b32 s2, s5, 0x7fff
; CI-NEXT:    s_cmpk_eq_i32 s2, 0x7c00
; CI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; CI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v0
; CI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; CI-NEXT:    s_or_b64 vcc, s[2:3], vcc
; CI-NEXT:    s_and_b32 s2, s7, 0x7fff
; CI-NEXT:    v_mov_b32_e32 v0, 0x7e00
; CI-NEXT:    s_cmpk_eq_i32 s2, 0x7c00
; CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; CI-NEXT:    v_cndmask_b32_e32 v3, v3, v0, vcc
...
; CI-NEXT:    s_cmpk_eq_i32 s2, 0x7c00
; CI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; CI-NEXT:    v_cndmask_b32_e32 v4, v5, v0, vcc
; CI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v1
; CI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; CI-NEXT:    s_or_b64 vcc, s[2:3], vcc
; CI-NEXT:    s_and_b32 s4, s6, 0x7fff
; CI-NEXT:    s_cmpk_eq_i32 s4, 0x7c00
; CI-NEXT:    v_cndmask_b32_e32 v1, v6, v0, vcc
; CI-NEXT:    v_cmp_nlg_f32_e32 vcc, 0, v2
; CI-NEXT:    s_cselect_b64 s[4:5], -1, 0
; CI-NEXT:    s_or_b64 vcc, s[4:5], vcc
; CI-NEXT:    v_cndmask_b32_e32 v0, v7, v0, vcc
; CI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; CI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
