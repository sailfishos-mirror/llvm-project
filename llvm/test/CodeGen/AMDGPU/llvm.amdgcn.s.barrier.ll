...
; VARIANT4-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; VARIANT4-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
; VARIANT4-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; VARIANT4-NEXT:    s_wait_kmcnt 0x0
; VARIANT4-NEXT:    global_store_b32 v2, v0, s[0:1]
; VARIANT4-NEXT:    s_barrier_signal -1
; VARIANT4-NEXT:    v_xad_u32 v0, v0, -1, s2
...
; VARIANT5-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; VARIANT5-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
; VARIANT5-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; VARIANT5-NEXT:    s_wait_kmcnt 0x0
; VARIANT5-NEXT:    global_store_b32 v2, v0, s[0:1]
; VARIANT5-NEXT:    s_barrier_signal -1
; VARIANT5-NEXT:    v_xad_u32 v0, v0, -1, s2
...
; VARIANT6-NEXT:    v_dual_mov_b32 v3, s1 :: v_dual_and_b32 v0, 0x3ff, v0
; VARIANT6-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; VARIANT6-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; VARIANT6-NEXT:    s_add_co_i32 s2, s2, -1
; VARIANT6-NEXT:    v_mov_b32_e32 v2, s0
; VARIANT6-NEXT:    global_store_b32 v4, v0, s[0:1]
; VARIANT6-NEXT:    s_barrier_signal -1
; VARIANT6-NEXT:    v_sub_nc_u32_e32 v0, s2, v0
