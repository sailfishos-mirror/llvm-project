...
; GFX1300-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-TRUE16-NEXT:    v_mov_b32_e32 v0, s2
; GFX1300-TRUE16-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24 nv
; GFX1300-TRUE16-NEXT:    v_ashr_pk_i8_i32 v0.l, s0, s1, v0
; GFX1300-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1300-TRUE16-NEXT:    global_store_b16 v1, v0, s[2:3]
...
; GFX1300-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-FAKE16-NEXT:    v_mov_b32_e32 v0, s2
; GFX1300-FAKE16-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24 nv
; GFX1300-FAKE16-NEXT:    v_ashr_pk_i8_i32 v0, s0, s1, v0
; GFX1300-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1300-FAKE16-NEXT:    global_store_b16 v1, v0, s[2:3]
