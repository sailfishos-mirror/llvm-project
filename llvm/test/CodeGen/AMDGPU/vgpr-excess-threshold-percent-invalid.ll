...
; NEGATIVE: for the --amdgpu-vgpr-excess-threshold-percent option: '-20' value invalid for uint argument!
; OVER100: for the --amdgpu-vgpr-excess-threshold-percent option: '140' value must be in the range [0, 100]!
