...
; GFX1332:       ; %bb.0: ; %entry
; GFX1332-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1332-NEXT:    v_mov_b32_e32 v3, exec_lo
; GFX1332-NEXT:    s_mov_b32 s4, exec_lo
; GFX1332-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1332-NEXT:    v_mbcnt_lo_u32_b32 v2, v3, 0
; GFX1332-NEXT:    v_cmpx_eq_u32_e32 0, v2
; GFX1332-NEXT:    s_cbranch_execz .LBB3_2
; GFX1332-NEXT:  ; %bb.1:
; GFX1332-NEXT:    v_bcnt_u32_b32 v0, v3, 0
; GFX1332-NEXT:    v_mov_b32_e32 v1, 0
; GFX1332-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1332-NEXT:    s_mov_b32 s10, -1
; GFX1332-NEXT:    s_wait_kmcnt 0x0
; GFX1332-NEXT:    s_mov_b32 s8, s2
; GFX1332-NEXT:    v_mul_lo_u32 v0, v0, 5
; GFX1332-NEXT:    s_mov_b32 s9, s3
; GFX1332-NEXT:    global_wb scope:SCOPE_DEV
; GFX1332-NEXT:    s_wait_storecnt 0x0
...
; GFX1332:       ; %bb.0: ; %entry
; GFX1332-NEXT:    v_mov_b32_e32 v8, exec_lo
; GFX1332-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1332-NEXT:    s_or_saveexec_b32 s0, -1
...
; GFX1332-NEXT:    v_mbcnt_lo_u32_b32 v0, v8, 0
; GFX1332-NEXT:    s_or_saveexec_b32 s6, -1
...
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s12, s[2:3], 0x0
...
; GFX7LESS-NEXT:    s_mul_i32 s2, s5, 5
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    v_subrev_i32_e32 v3, vcc, s2, v4
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
...
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s5, s[6:7]
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dword s13, s[2:3], 0x0
; GFX7LESS-NEXT:    s_mov_b64 s[10:11], 0
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
; GFX7LESS-NEXT:    s_mul_i32 s2, s12, s5
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    s_bcnt1_i32_b64 s5, s[6:7]
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x0
; GFX7LESS-NEXT:    s_mov_b64 s[10:11], 0
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
...
; GFX7LESS-NEXT:    v_subrev_i32_e32 v5, vcc, s2, v7
...
; GFX7LESS-NEXT:    s_mov_b32 s6, -1
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
; GFX7LESS-NEXT:    s_mul_i32 s2, s9, s5
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, s5
; GFX7LESS-NEXT:    v_mul_hi_u32 v0, s8, v0
; GFX7LESS-NEXT:    s_mul_i32 s5, s8, s5
; GFX7LESS-NEXT:    v_add_i32_e32 v5, vcc, s2, v0
; GFX7LESS-NEXT:    v_mov_b32_e32 v6, s5
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
; GFX7LESS-NEXT:    v_cvt_f32_f16_e32 v3, s5
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    s_load_dword s11, s[2:3], 0x0
; GFX7LESS-NEXT:    s_mov_b32 s4, s2
; GFX7LESS-NEXT:    v_mul_f32_e64 v0, 1.0, s10
...
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    s_and_b32 s2, s11, 0xffff0000
; GFX7LESS-NEXT:    s_lshl_b32 s5, s11, 16
