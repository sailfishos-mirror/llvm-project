...
; SI-SDAG-NEXT:    v_mul_f64 v[15:16], v[9:10], s[12:13]
...
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[15:16], s[16:17], v[10:11]
...
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v19, v[12:13]
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], v[15:16], v[17:18], 1.0
; SI-SDAG-NEXT:    v_add_f64 v[15:16], v[2:3], v[8:9]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 vcc, |v[2:3]|, s[10:11]
; SI-SDAG-NEXT:    v_add_f64 v[15:16], v[15:16], -v[8:9]
; SI-SDAG-NEXT:    v_ldexp_f64 v[12:13], v[12:13], v19
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v16, v16, v3, vcc
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v15, v15, v2, vcc
; SI-SDAG-NEXT:    v_add_f64 v[17:18], v[2:3], -v[15:16]
; SI-SDAG-NEXT:    s_mov_b32 s44, 0
; SI-SDAG-NEXT:    v_mul_f64 v[19:20], v[17:18], s[12:13]
; SI-SDAG-NEXT:    s_mov_b32 s45, 0x40900000
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[17:18], s[14:15], v[19:20]
; SI-SDAG-NEXT:    s_mov_b32 s46, 0
; SI-SDAG-NEXT:    s_mov_b32 s47, 0xc090cc00
; SI-SDAG-NEXT:    v_cmp_nlt_f64_e32 vcc, s[44:45], v[0:1]
; SI-SDAG-NEXT:    v_cmp_ngt_f64_e64 s[4:5], s[46:47], v[0:1]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], s[16:17], v[10:11]
; SI-SDAG-NEXT:    v_mov_b32_e32 v20, 0x7ff00000
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[18:19]
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v19, v20, v13, vcc
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[20:21]
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v13, v[15:16]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[22:23]
; SI-SDAG-NEXT:    v_bfi_b32 v9, s56, v14, v5
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[24:25]
; SI-SDAG-NEXT:    v_add_f64 v[15:16], v[4:5], v[8:9]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[26:27]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[4:5]|, s[10:11]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[28:29]
; SI-SDAG-NEXT:    v_cmp_ngt_f64_e64 s[8:9], s[46:47], v[2:3]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[40:41]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 s[10:11], |v[6:7]|, s[10:11]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], s[42:43]
; SI-SDAG-NEXT:    s_and_b64 vcc, s[4:5], vcc
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], 1.0
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[17:18], v[0:1], 1.0
; SI-SDAG-NEXT:    v_ldexp_f64 v[17:18], v[0:1], v13
; SI-SDAG-NEXT:    v_add_f64 v[0:1], v[15:16], -v[8:9]
; SI-SDAG-NEXT:    v_bfi_b32 v9, s56, v14, v7
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v1, v1, v5, s[6:7]
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, v0, v4, s[6:7]
; SI-SDAG-NEXT:    v_add_f64 v[15:16], v[4:5], -v[0:1]
; SI-SDAG-NEXT:    v_cmp_nlt_f64_e64 s[6:7], s[44:45], v[2:3]
; SI-SDAG-NEXT:    v_mul_f64 v[2:3], v[15:16], s[12:13]
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v21, v20, v18, s[6:7]
; SI-SDAG-NEXT:    v_fma_f64 v[15:16], v[15:16], s[14:15], v[2:3]
; SI-SDAG-NEXT:    v_add_f64 v[2:3], v[6:7], v[8:9]
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v22, v[0:1]
; SI-SDAG-NEXT:    v_add_f64 v[2:3], v[2:3], -v[8:9]
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, v19, s[4:5]
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v9, v3, v7, s[10:11]
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v8, v2, v6, s[10:11]
; SI-SDAG-NEXT:    v_add_f64 v[2:3], v[6:7], -v[8:9]
; SI-SDAG-NEXT:    v_fma_f64 v[18:19], v[15:16], s[16:17], v[10:11]
; SI-SDAG-NEXT:    v_mul_f64 v[13:14], v[2:3], s[12:13]
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v12, vcc
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], v[2:3], s[14:15], v[13:14]
; SI-SDAG-NEXT:    s_and_b64 vcc, s[8:9], s[6:7]
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 0, v17, vcc
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[15:16], v[18:19], s[18:19]
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[12:13], s[16:17], v[10:11]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[15:16], v[17:18], s[20:21]
...
; SI-SDAG-NEXT:    v_fma_f64 v[14:15], v[15:16], v[17:18], 1.0
...
; SI-SDAG-NEXT:    v_cmp_nlt_f64_e32 vcc, s[44:45], v[4:5]
; SI-SDAG-NEXT:    v_cmp_ngt_f64_e64 s[4:5], s[46:47], v[4:5]
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[12:13], v[10:11], 1.0
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v9, v20, v15, vcc
; SI-SDAG-NEXT:    s_and_b64 vcc, s[4:5], vcc
...
; SI-SDAG-NEXT:    v_cmp_nlt_f64_e32 vcc, s[44:45], v[6:7]
; SI-SDAG-NEXT:    v_cmp_ngt_f64_e64 s[4:5], s[46:47], v[6:7]
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v9, v20, v9, vcc
; SI-SDAG-NEXT:    s_and_b64 vcc, s[4:5], vcc
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v3, 0, v21, s[8:9]
...
; SI-GISEL-NEXT:    v_or_b32_e32 v11, 0x43300000, v11
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v22, v16, v2, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v23, v17, v3, vcc
...
; SI-GISEL-NEXT:    v_mul_f64 v[28:29], v[20:21], v[14:15]
; SI-GISEL-NEXT:    v_mul_f64 v[30:31], v[26:27], v[14:15]
; SI-GISEL-NEXT:    v_and_b32_e32 v11, 0x80000000, v7
; SI-GISEL-NEXT:    v_or_b32_e32 v11, 0x43300000, v11
; SI-GISEL-NEXT:    v_fma_f64 v[28:29], v[20:21], v[12:13], v[28:29]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[26:27], v[12:13], v[30:31]
...
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], v[24:25], v[14:15], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[30:31], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[34:35]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[26:27]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[48:49]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[18:19]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], v[52:53]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[28:29], v[24:25], 1.0
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v28, v[8:9]
; SI-GISEL-NEXT:    v_ldexp_f64 v[22:23], v[24:25], v22
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[30:31], v[32:33]
; SI-GISEL-NEXT:    v_mov_b32_e32 v8, 0
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[34:35]
; SI-GISEL-NEXT:    v_ldexp_f64 v[14:15], v[14:15], v28
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[26:27]
; SI-GISEL-NEXT:    v_fma_f64 v[28:29], v[12:13], v[30:31], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[28:29], v[12:13], v[28:29], v[34:35]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[48:49]
; SI-GISEL-NEXT:    v_fma_f64 v[26:27], v[12:13], v[28:29], v[26:27]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[26:27], v[12:13], v[26:27], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[18:19]
; SI-GISEL-NEXT:    v_fma_f64 v[26:27], v[12:13], v[26:27], v[48:49]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[26:27], v[12:13], v[26:27], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[20:21], v[24:25], v[52:53]
; SI-GISEL-NEXT:    v_mov_b32_e32 v9, 0x40900000
; SI-GISEL-NEXT:    v_fma_f64 v[18:19], v[12:13], v[26:27], v[18:19]
...
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v26, v[16:17]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[12:13], v[18:19], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[18:19], v[20:21], v[24:25], 1.0
; SI-GISEL-NEXT:    v_mov_b32_e32 v21, 0x7ff00000
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v14, 0, v14, vcc
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v20, v[10:11]
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v10, v21, v15, vcc
; SI-GISEL-NEXT:    v_cmp_nlt_f64_e32 vcc, v[0:1], v[30:31]
; SI-GISEL-NEXT:    v_cmp_ngt_f64_e64 s[4:5], v[2:3], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[12:13], v[16:17], v[52:53]
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0, v14, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v1, 0, v10, vcc
; SI-GISEL-NEXT:    v_cmp_nlt_f64_e32 vcc, v[2:3], v[30:31]
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v22, 0, v22, s[4:5]
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v10, v21, v23, s[4:5]
; SI-GISEL-NEXT:    v_ldexp_f64 v[18:19], v[18:19], v26
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v2, 0, v22, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v3, 0, v10, vcc
; SI-GISEL-NEXT:    v_cmp_ngt_f64_e32 vcc, v[4:5], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[12:13], v[16:17], 1.0
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v14, 0, v18, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v15, v21, v19, vcc
...
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v9, v21, v11, vcc
...
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v2, s[8:9]
...
; SI-GISEL-NEXT:    v_cmp_ngt_f64_e32 vcc, s[2:3], v[2:3]
