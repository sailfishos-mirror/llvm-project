...
; GISEL-NEXT:    v_mov_b64_e32 v[12:13], s[20:21]
; GISEL-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; GISEL-NEXT:    v_mov_b32_e32 v42, s0
; GISEL-NEXT:    v_mov_b32_e32 v43, s1
; GISEL-NEXT:    v_mov_b64_e32 v[34:35], s[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[32:33], s[8:9]
; GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 v[0:15], v[16:23], v[24:31], v[0:15], v42, v43 op_sel_hi:[0,0,0]
; GISEL-NEXT:    v_mov_b64_e32 v[38:39], s[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[36:37], s[12:13]
; GISEL-NEXT:    v_mov_b64_e32 v[24:25], 16
; GISEL-NEXT:    v_mov_b64_e32 v[26:27], 32
; GISEL-NEXT:    v_mov_b64_e32 v[28:29], 48
...
; GISEL-NEXT:    global_store_dwordx4 v[40:41], v[32:35], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[24:25], v[36:39], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[26:27], v[16:19], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[28:29], v[20:23], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 2
; GISEL-NEXT:    global_store_dwordx4 v[40:41], v[0:3], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[24:25], v[4:7], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[26:27], v[8:11], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[28:29], v[12:15], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_endpgm
;
...
; AGPR-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x0
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v2, s8
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v3, s9
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v4, s10
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v5, s11
...
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v10, s16
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v11, s17
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v12, s18
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v13, s19
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v14, s20
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v15, s21
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v16, s22
; AGPR-SDAG-NEXT:    v_mov_b32_e32 v17, s23
; AGPR-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; AGPR-GISEL-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-GISEL-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[20:21], 0
; AGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[36:37]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[38:39]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[40:41]
...
; AGPR-GISEL-NEXT:    v_mov_b32_e32 v22, s0
; AGPR-GISEL-NEXT:    v_mov_b32_e32 v23, s1
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[10:11]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; AGPR-GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 a[0:15], v[0:7], v[8:15], a[0:15], v22, v23 op_sel_hi:[0,0,0]
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[20:21], v[16:19], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[12:13]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[14:15]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[16:17], 16
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[16:17], v[0:3], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[18:19], 32
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[22:23], 48
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[16:17]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[18:19]
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[18:19], v[0:3], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    s_nop 0
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[20:21]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[22:23]
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[22:23], v[0:3], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    s_nop 1
; AGPR-GISEL-NEXT:    v_accvgpr_read_b32 v0, a0
; AGPR-GISEL-NEXT:    v_accvgpr_read_b32 v1, a1
...
; AGPR-GISEL-NEXT:    v_accvgpr_read_b32 v14, a14
; AGPR-GISEL-NEXT:    v_accvgpr_read_b32 v15, a15
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[20:21], v[0:3], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[16:17], v[4:7], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[18:19], v[8:11], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
...
; GISEL-NEXT:    v_mov_b64_e32 v[38:39], 16
...
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[38:39], v[16:19], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[28:29], v[20:23], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[30:31], v[24:27], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_nop 2
; GISEL-NEXT:    global_store_dwordx4 v[36:37], v[0:3], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[38:39], v[4:7], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[28:29], v[8:11], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    global_store_dwordx4 v[30:31], v[12:15], off sc0 sc1
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_endpgm
;
...
; AGPR-GISEL-NEXT:    s_load_dwordx16 s[36:51], s[4:5], 0x0
; AGPR-GISEL-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-GISEL-NEXT:    v_mov_b32_e32 v22, 25
; AGPR-GISEL-NEXT:    v_mov_b32_e32 v23, 42
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[20:21], 0
; AGPR-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[36:37]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[38:39]
...
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[10:11]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; AGPR-GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 a[0:15], v[0:7], v[8:15], a[0:15], v22, v23 op_sel_hi:[0,0,0] blgp:2
; AGPR-GISEL-NEXT:    global_store_dwordx4 v[20:21], v[16:19], off sc0 sc1
; AGPR-GISEL-NEXT:    s_waitcnt vmcnt(0)
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[12:13]
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[14:15]
