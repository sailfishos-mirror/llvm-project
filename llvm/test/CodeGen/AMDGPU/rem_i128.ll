...
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v7, v3, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v6, v10, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[6:7], v11, v[0:1]
...
; GFX9-NEXT:    v_or3_b32 v8, v8, v16, v14
; GFX9-NEXT:    v_sub_co_u32_e64 v16, s[4:5], v28, v12
; GFX9-NEXT:    v_subb_co_u32_e64 v16, s[4:5], v29, v13, s[4:5]
...
; GFX9-NEXT:    v_subb_co_u32_e64 v16, s[4:5], v31, v17, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v25, vcc, -1, v25, vcc
; GFX9-NEXT:    v_or_b32_e32 v6, v18, v6
; GFX9-NEXT:    v_ashrrev_i32_e32 v18, 31, v16
; GFX9-NEXT:    v_addc_co_u32_e32 v26, vcc, -1, v26, vcc
; GFX9-NEXT:    v_and_b32_e32 v16, v18, v22
; GFX9-NEXT:    v_addc_co_u32_e32 v27, vcc, -1, v27, vcc
; GFX9-NEXT:    v_or_b32_e32 v7, v19, v7
; GFX9-NEXT:    v_and_b32_e32 v19, v18, v21
; GFX9-NEXT:    v_sub_co_u32_e64 v12, s[4:5], v12, v16
; GFX9-NEXT:    v_or_b32_e32 v32, v24, v26
; GFX9-NEXT:    v_or_b32_e32 v33, v25, v27
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v13, v19, s[4:5]
; GFX9-NEXT:    v_and_b32_e32 v16, v18, v4
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[32:33]
; GFX9-NEXT:    v_and_b32_e32 v19, v18, v5
; GFX9-NEXT:    v_subb_co_u32_e64 v16, s[4:5], v10, v16, s[4:5]
; GFX9-NEXT:    v_subb_co_u32_e64 v17, s[4:5], v17, v19, s[4:5]
; GFX9-NEXT:    v_and_b32_e32 v10, 1, v18
...
; GFX9-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v22, v13, 0
; GFX9-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-NEXT:    v_mul_lo_u32 v17, v13, v5
; GFX9-NEXT:    v_mul_lo_u32 v7, v12, v4
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v21, v13, v[15:16]
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v4, 0
; GFX9-NEXT:    v_mul_lo_u32 v13, v8, v21
; GFX9-NEXT:    v_mul_lo_u32 v9, v9, v22
; GFX9-NEXT:    v_mov_b32_e32 v15, v5
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v22, v12, v[15:16]
; GFX9-NEXT:    v_add3_u32 v11, v11, v17, v7
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v8, v22, v[10:11]
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v6, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v21, v12, v[5:6]
...
; GFX9-NEXT:    v_or_b32_e32 v12, v9, v11
...
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v9, v3, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v10, v8, v12, vcc
...
; GFX9-NEXT:    v_or3_b32 v10, v10, v18, v16
; GFX9-NEXT:    v_sub_co_u32_e64 v18, s[4:5], v26, v14
; GFX9-NEXT:    v_subb_co_u32_e64 v18, s[4:5], v27, v15, s[4:5]
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], 1, v[8:9]
...
; GFX9-NEXT:    v_or3_b32 v11, v11, 0, v17
; GFX9-NEXT:    s_or_b64 s[10:11], vcc, s[10:11]
...
; GFX9-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v4, v15, 0
; GFX9-NEXT:    v_mov_b32_e32 v18, 0
; GFX9-NEXT:    v_mul_lo_u32 v19, v15, v7
; GFX9-NEXT:    v_mul_lo_u32 v9, v14, v6
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v5, v15, v[17:18]
...
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v4, v14, v[17:18]
; GFX9-NEXT:    v_add3_u32 v13, v13, v19, v9
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v10, v4, v[12:13]
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v8, v7
; GFX9-NEXT:    v_addc_co_u32_e64 v8, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v5, v14, v[7:8]
; GFX9-NEXT:    v_add3_u32 v7, v11, v10, v15
