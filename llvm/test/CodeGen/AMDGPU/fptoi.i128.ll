...
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v12, v9, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v13, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v11, v8, 0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v13, v8, v[5:6]
; GISEL-NEXT:    v_mul_lo_u32 v14, v12, v10
; GISEL-NEXT:    v_mul_lo_u32 v10, v11, v10
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v11, v9, v[1:2]
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v12, v8, v[5:6]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[10:11], v3, v10, s[10:11]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[8:9], v3, v14, s[8:9]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v13, v9, v[3:4]
...
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[6:7], v4, v10, 0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, v0, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, v1, s[4:5]
...
; GISEL-NEXT:    v_lshlrev_b64 v[3:4], v3, v[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v13, v8, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v3, v10, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v10, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v12, v7, 0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v10, v7, v[5:6]
; GISEL-NEXT:    v_mul_lo_u32 v14, v13, v9
; GISEL-NEXT:    v_mul_lo_u32 v9, v12, v9
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v12, v8, v[1:2]
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v13, v7, v[5:6]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[10:11], v3, v9, s[10:11]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[8:9], v3, v14, s[8:9]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v10, v8, v[3:4]
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v4, v11, s[4:5]
...
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v6, v9, 0
; GISEL-NEXT:    v_mul_lo_u32 v7, v6, v9
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v6, v8, v[1:2]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[4:5], v3, v7, s[4:5]
