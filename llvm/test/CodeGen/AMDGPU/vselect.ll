...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_cmp_gt_i32 s3, s5
; SI-NEXT:    s_cselect_b32 s0, s7, s3
; SI-NEXT:    s_cmp_gt_i32 s2, s4
; SI-NEXT:    s_cselect_b32 s1, s6, s2
...
; SI-NEXT:    s_mov_b32 s11, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_load_dwordx4 s[12:15], s[2:3], 0x0
; SI-NEXT:    s_load_dwordx4 s[16:19], s[8:9], 0x0
; SI-NEXT:    s_mov_b32 s10, -1
; SI-NEXT:    s_mov_b32 s8, s0
; SI-NEXT:    s_mov_b32 s9, s1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_cmp_gt_i32 s14, s18
; SI-NEXT:    s_cselect_b32 s0, s6, s14
; SI-NEXT:    s_cmp_gt_i32 s13, s17
; SI-NEXT:    s_cselect_b32 s1, s5, s13
; SI-NEXT:    s_cmp_gt_i32 s15, s19
; SI-NEXT:    v_mov_b32_e32 v2, s0
; SI-NEXT:    s_cselect_b32 s0, s7, s15
; SI-NEXT:    s_cmp_gt_i32 s12, s16
; SI-NEXT:    v_mov_b32_e32 v1, s1
; SI-NEXT:    s_cselect_b32 s1, s4, s12
